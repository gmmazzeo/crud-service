...
public class InvalidClassException extends ServiceException {
    Class classExpected, classFound;
    
    public InvalidClassException(Class classExpected, Class classFound, String message) {
        super(ServiceException.INVALID_CLASS, message, message);
        this.classExpected=classExpected;
        this.classFound=classFound;
    }

    public Class getClassExpected() {
        return classExpected;
    }

    public Class getClassFound() {
        return classFound;
    }
}
